...
def go(args):
    ...
    logger.info("Getting train and validation artifact")
    ...
    # YOUR CODE HERE
    ######################################
    export_model(run, sk_pipe, processed_features, X_val, y_pred, args, rf_config)
...
def export_model(run, pipe, used_columns, X_val, val_pred, args, rf_config):
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # I have taken this part out, I have already done the corresponding preprocessing of the dates in the basic_cleaning step.
